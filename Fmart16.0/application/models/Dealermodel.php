...
function furniture($deal_id)
    {
        $query=$this->db->get_where('tbl_furniture',array('deal_id'=>$deal_id));
        return $query->result();
    }
...
function image()
    ...
    function furniture_edit($value)
    {
        $data=$this->db->get_where('tbl_furniture',$value);
        return $data->result();
    }
