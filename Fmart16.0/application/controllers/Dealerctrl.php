...
{ 
    ...
    $furniture=array('deal_id'=>$did,'category_id'=>$cat,'type_id'=>$type,'material_id'=>$material,'name'=>$name,'price'=>$price,'description'=>$desc,'image'=>$homeimg,'status'=>1);
...
public function update_furniture()
{
    $f_id=$this->input->post('f_id');
    $value=array('furniture_id'=>$f_id,'status'=>1);
    $data['furniture']=$this->Dealermodel->furniture_edit($value);
    print_r($data['furniture']);
