					...
					<div class="modal-content">
						...
						<form action='<?php echo site_url("Dealerctrl/update_profile") ?>' method='post' >
                            ...
                            <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="district" name="district" value="<?php echo $district; ?>"  prediction="false" autocomplete="false" class="form-control">
                                            </div>
                            </div>
                            ...
                            <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="state" name="state" value="<?php echo $state; ?>"  prediction="false" autocomplete="false" class="form-control">
                                            </div>
                            </div>
