    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                 <li><a href="<?php echo site_url('Custctrl/cust_home1')?>">Home</a></li>
                    ...
                    <li><a href="<?php echo site_url('Custctrl/quotation')?>">Quotation</a>

                    <li><a href="<?php echo site_url('Custctrl/profile')?>">Profile</a>
            ...
            <div class="cart-fav-search mb-100">
                <a href="<?php echo site_url('Custctrl/cart')?>" class="cart-nav"><img src="<?php echo base_url(); ?>img/core-img/cart.png" alt=""> Cart <span>(<?php echo $count; ?>)</span></a>

                <a href="<?php echo site_url('Fmartctrl/logout')?>" class="cart-nav"><img src="<?php echo base_url(); ?>img/core-img/logouticon.jpg" alt=""> Logout</a>
