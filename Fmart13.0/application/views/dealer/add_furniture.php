                                ...
                                <form action='<?php echo site_url("Dealerctrl/add"); ?>' method='post' onsubmit='return' enctype='multipart/form-data' >
                                    ...
                                    function capitalize(textboxid, str) {
                                        ...
                                        <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select name="category" id="category1" onchange="sel_type()" class="form-control" required>
                            ...
                            function sel_type()
                            {
                                ...
                                data.append('category',category);
                                    ...
                                    <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="description" id="description" rows="9" placeholder="Description..." class="form-control" required></textarea>
                                                </div>
                                    </div>
                                    <div class="row form-group">
                                                <div class="col col-md-3">
