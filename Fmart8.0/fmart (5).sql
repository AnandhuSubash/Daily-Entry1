...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2019 at 01:30 PM
...
(27, 'tim@gmail.com', 'tim', 'dealer', 1, 1);
...
(1, 6, 1, 5, 3, 'table', 3000, 'bedroom table', '1556177290sofa.jpg'),
(2, 6, 7, 2, 3, 'Dining table', 4500, 'Wooden dining table', '1556186128qwwee.jpg'),
(3, 6, 1, 4, 3, 'Bed', 3000, 'Wooden bed', '1556186238download.jpg'),
(4, 6, 9, 8, 3, 'Sofa', 2500, 'Sofa for drawing room', '1556186360imageService.jpg'),
(5, 6, 1, 4, 3, 'Fostin', 65000, 'Best Bed in Town', '15562508212.Fabric-Bed_2048x2048.jpeg'),
(6, 6, 7, 7, 3, 'chair', 1200, 'Dining chair', '155634408931051.jpg'),
(7, 6, 7, 2, 3, 'Dining table', 4500, 'Wooden dining table for six seats.\r\n', '1556515359aa.jpg'),
(8, 8, 9, 9, 2, 'Chair', 1000, 'Plastic chair ideal for drawing room', '1556516098chair2.jpg');
...
--
ALTER TABLE `login`
  MODIFY `log_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_dimension`
  MODIFY `dim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_furniture`
--
ALTER TABLE `tbl_furniture`
  MODIFY `furniture_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
