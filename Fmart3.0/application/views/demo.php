...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="<?php echo base_url(); ?>images/icon/admin.png" alt="Admin" />
                </a>
            </div>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>images/icon/admin-img.png" alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
...
<div class="row m-t-30">
                            <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Add Furniture Type</h3>
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <?php
                                            foreach($cat as $cate)
                                            {
                                                ...
                                                <option><?php echo $cate->c_name; ?></option>
