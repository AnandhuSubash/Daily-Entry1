                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="#" class="oh-autoval-form" method="post" onsubmit="return">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="av-name form-control" name="fname" value="" placeholder="First Name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="av-name form-control" name="lname" value="" placeholder="Last Name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="mobile" class=" av-mobile form-control" name="mobile"  placeholder="Phone No" value="">
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                        <input type="email" class="oh-autoval av-email form-control" av-message="invalid email"  name="email" placeholder="Email" value="">
                                    </div>
                                    <div class="col-12 mb-3">
