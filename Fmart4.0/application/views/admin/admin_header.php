                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo site_url("Adminctrl/cust_list")?>">
                                <i class="fas fa-group"></i>Customers</a>
                                

                        </li>
                        <li>
                            <a href="<?php echo site_url("Adminctrl/deal_list")?>">
                                <i class="fas fa-users"></i>Dealers</a>
                        ...
                        <li>
                            <a href="<?php echo site_url("Adminctrl/type")?>">
                                <i class="fas fa-table"></i>Furniture Type</a>

                        </li>


                        <li>
                            <a href="<?php echo site_url("Adminctrl/material")?>">
                                <i class="fas fa-table"></i>Furniture material</a>
